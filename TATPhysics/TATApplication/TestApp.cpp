...
void TestApp::CreateScene()
{
	...
	TATRigidBody* sphereRb = TATDynamicWorld::Instance()->CreateSphere(TATVector3(0, 0, 0), 30, 1.0);
	TATDynamicWorld::Instance()->InitializeRb(sphereRb, TATransform(TATQuaternion::GetIdentity(), TATVector3(0, 50, 50)), 1.0f, 0.8, 0.2, TATVector3(0, -10, 0));
